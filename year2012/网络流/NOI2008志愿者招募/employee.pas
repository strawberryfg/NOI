...
var n,m,s,t,i,v,ll,rr,cost,tot:longint;
...
readln(n,m);
s:=0; t:=n+2;
for i:=1 to n do begin read(v); addedge(s,i,v,0); addedge(i+1,t,v,0); end;
for i:=1 to m do begin readln(ll,rr,cost); addedge(ll,rr+1,inf,cost); end;
for i:=2 to n+1 do addedge(i,i-1,inf,0);
ans:=0;
while spfa do work;
writeln(ans);
close(input);
