...
type rec=record x,y:int64; id:longint; end;
var n,i,j:longint;
    ...
    res,ans:int64;
function max(x,y:int64):int64; begin if x>y then max:=x else max:=y; end;
function cross(opt:longint; ny,nx:int64):boolean;
begin
...
procedure add(opt,nowid:longint; ny,nx:int64);
begin
...
function check(opt:longint; num:int64):boolean;
begin
...
procedure delete(opt:longint; num:int64);
begin
